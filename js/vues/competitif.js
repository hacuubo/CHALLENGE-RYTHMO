...
export function vueCompetitif(app, { demarrer }) {
  ...
  app.innerHTML = `
    ...
    <section class="carte">
      ...
      <ul class="liste-regles">
        ...
        <li>Les questions arrivent en continu, choisies juste au-dessus de votre classement ; arrêtez quand vous voulez.</li>
        <li>Les questions ouvertes (auto-évaluées) ne sont pas proposées. Seul ce mode fait varier l'ELO : l'entraînement est une « partie amicale ».</li>
      </ul>
  ...
  app.querySelector('#jouer').onclick = () => demarrer([], 'Partie compétitive', { competitif: true });
}
