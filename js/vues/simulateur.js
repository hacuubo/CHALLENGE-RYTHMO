  ...
  app.innerHTML = `
    ...
    <details class="carte simu-guide">
      ...
      <ul>
        ...
        <li><b>Flutter</b> : entraînez depuis l'isthme cavo-tricuspide (site « Isthme cavo-tricuspide », salve 10-20 ms plus rapide que le flutter) puis depuis le SC distal, et comparez les PPI − TCL mesurés sur la voie stimulée. Après ablation de l'isthme, stimulez l'ostium du SC : une activation latérale descendante (OD lat. haute avant basse) signe le bloc isthmique.</li>
