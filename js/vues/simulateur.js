...
export function vueSimulateur(app) {
  ...
  app.innerHTML = `
    ...
    <details class="carte simu-guide">
      ...
      <ul>
        <li><b>Tracés</b> : DII et V1 en surface ; OD haute ; His (A, H, V) ; sinus coronaire du proximal (9-10, ostium) au distal (1-2, anneau mitral latéral) ; VD apex. « S » en haut = stimulus capturant, « s » = non capturant.</li>
