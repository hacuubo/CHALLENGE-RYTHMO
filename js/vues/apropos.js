...
export function vueAPropos(app) {
  ...
  app.innerHTML = `
    ...
    <section class="carte"><h2>Simulateur d'électrophysiologie</h2>
      <p class="note">Modèle pédagogique original : le cœur est représenté par un réseau de sites (oreillettes, His, sinus coronaire, ventricules) reliés par des voies de conduction avec délais décrémentiels et périodes réfractaires ; les réentrées émergent du modèle. Le concept s'inspire du simulateur <a href="https://svtsim.com/" target="_blank" rel="noopener noreferrer">svtsim</a> (S. Iravanian, licence CC BY-NC 4.0), sans reprise de son code. Critères diagnostiques : Michaud GF et al., JACC 2001;38:1163-7 ; Knight BP et al., JACC 1999;33:775-81 ; Josephson ME, <i>Clinical Cardiac Electrophysiology</i>.</p>
    </section>
