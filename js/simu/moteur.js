...
export class Coeur {
  ...
  // canal : cathéter qui délivre le stimulus quand ce n'est pas celui du site (sonde d'ablation)
  stimuler(site, t, sortie = 5, largeur = 2, lib = null, canal = null) { this.tas.pousser({ t, type: 'stim', s: site, sortie, largeur, lib, canal }); }
