...
export const CANAUX = [
  ...
  { id: 'pa', nom: 'PA', court: 'PA', coul: 'pa', pression: true },
];

export const MONTAGES = {
  standard: { nom: 'Standard (TSV)', voies: ['I', 'II', 'V1', 'hra', 'hisp', 'hisd', 'cs9', 'cs7', 'cs5', 'cs3', 'cs1', 'rva', 'pa'] },
  ...
  compact: { nom: 'Réduit (téléphone)', voies: ['II', 'V1', 'hra', 'hisd', 'cs9', 'cs1', 'rva', 'abld'] },
