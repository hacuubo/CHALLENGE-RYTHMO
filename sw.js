...
const VERSION = 'rythmo-8366b52140'; // mis à jour par scripts/build-index.mjs
const COQUILLE = ['./', 'index.html', 'en/', 'en/index.html', 'js/i18n.js', 'css/styles.css', 'manifest.webmanifest', 'icons/icon.svg', 'icons/icon-192.png', 'icons/icon-512.png',
  ...
  'js/vues/simulateur.js', 'js/simu/moteur.js', 'js/simu/scenarios.js', 'js/simu/trace.js', 'js/simu/analyse.js', 'js/simu/rejeu.js',
  'js/vues/entrainement.js', 'js/vues/simu-menu.js', 'js/icones.js'];
